...
# This guarantees the DB is created in the same folder as this script
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DATABASE_PATH = os.path.join(BASE_DIR, "zakat_database.db")


def get_db_connection():
    """Get database connection with row factory for dict-like access."""
    # THREAD SAFETY
    # check_same_thread=False prevents errors if Flask uses multiple threads
